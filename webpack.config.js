...
module.exports = {
    ...
    module: { // optional modules defined in rules (there can be many objects under rules)
        rules: [
            ...
            },
            {
                ...
                // postcss-loader will transpile, css-loader makes it possible to import styles
                // using @import, and style loader will let webpack pack into index html
            },

        ],
    },
    devServer: {
        // if url path is not found, redirect to index.html (so the react router can handle it)
    ...
    plugins: [
        ...
        new webpack.DefinePlugin({
            // replace API_URL (or any name defined here) with value defined in .env file
            // we could also just use "process.env.API_URL" in the scripts,
